...
- `Makefile/` — explain what lives here and when agents should edit it.
- `man/` — explain what lives here and when agents should edit it.
...
- `tests/` — explain what lives here and when agents should edit it.
