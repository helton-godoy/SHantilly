...
void TestSHantillyBuilder::testBuildSelectionWidgets()
{
    ...
    // Test CheckBox
    Sbx::Models::CheckBoxConfig checkConfig;
    ...
    // Test RadioButton
    Sbx::Models::RadioButtonConfig radioConfig;
...
void TestSHantillyBuilder::testBuildUtilityWidgets()
{
    ...
    // Test Calendar
    Sbx::Models::CalendarConfig calConfig;
    ...
    // Test Separator
    Sbx::Models::SeparatorConfig sepConfig;
    sepConfig.name = "sep1";
...
void TestSHantillyBuilder::testBuildNumericalInputs()
{
    ...
    // Test SpinBox
    Sbx::Models::SpinBoxConfig spinConfig;
    ...
    // Test Slider
    Sbx::Models::SliderConfig sliderConfig;
...
void TestSHantillyBuilder::testBuildTextInputs()
{
    ...
    // Test TextEdit
    Sbx::Models::TextEditConfig textConfig;
...
void TestSHantillyBuilder::testBuildBasicContainers()
{
    ...
    // Test GroupBox
    Sbx::Models::GroupBoxConfig gbConfig;
    gbConfig.name = "gb1";
    gbConfig.title = "My Group";
    gbConfig.layout.type = Sbx::Models::SbxLayoutConfig::VBox;
    ...
    // Test Frame
    Sbx::Models::FrameConfig frConfig;
    frConfig.name = "fr1";
    frConfig.layout.type = Sbx::Models::SbxLayoutConfig::HBox;
...
QTEST_MAIN(TestSHantillyBuilder)
