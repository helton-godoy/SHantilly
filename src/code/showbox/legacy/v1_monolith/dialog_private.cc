 ...
 ******************************************************************************/
void ShowBox::updateTabsOrder(QWidget *page)
{
 ...
 ******************************************************************************/
bool ShowBox::isEmpty(QLayout *layout)
{
    // Note:
 ...
 *    - is not the last one
 ******************************************************************************/
bool ShowBox::removeIfEmpty(QLayout *layout)
{
    QLayout *parent;
 ...
 *  items only.
 ******************************************************************************/
void ShowBox::sanitizeLayout(QLayout *layout)
{
 ...
 ******************************************************************************/
void ShowBox::sanitizeLabel(QWidget *label, enum ContentType content)
{
...
void ShowBox::printWidgetsRecursively(QLayoutItem *item)
{
    QLayout *layout;
    QWidget *widget;
...
void ShowBox::printWidget(QWidget *widget)
