...
void ThemeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onColorSchemeChanged((*reinterpret_cast< std::add_pointer_t<Qt::ColorScheme>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ThemeManager::*)(ThemeMode );
...
// SIGNAL 0
void ThemeManager::themeChanged(ThemeMode _t1)
{
