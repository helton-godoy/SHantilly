 ...
 ******************************************************************************/
void ShowBox::removePage(QObject *page)
{
 ...
 ******************************************************************************/
void ShowBox::pushButtonClicked()
{
 ...
 ******************************************************************************/
void ShowBox::pushButtonToggled(bool checked)
{
 ...
 ******************************************************************************/
void ShowBox::listBoxItemActivated(const QModelIndex &index)
{
 ...
 ******************************************************************************/
void ShowBox::listBoxItemSelected(QListWidgetItem *current)
{
    ListBox *list = (ListBox *)sender();
    QLayout *layout;
    QWidget *label;
 ...
 ******************************************************************************/
void ShowBox::comboBoxItemSelected(int index)
{
    Q_UNUSED(index);
    report();
}

void ShowBox::tableCellEdited(int row, int col, const QString &text)
{
    const char *objectName = sender()->objectName().toLocal8Bit().constData();
    if (objectName[0]) {
...
void ShowBox::tableRowSelected(int row)
{
    const char *objectName = sender()->objectName().toLocal8Bit().constData();
    if (objectName[0]) {
...
void ShowBox::chartItemClicked(const QString &label)
{
    const char *objectName = sender()->objectName().toLocal8Bit().constData();
    if (objectName[0]) {
...
void ShowBox::calendarSelected()
{
    report();
}

void ShowBox::sliderValueChanged(int value)
{
    const char *objectName = sender()->objectName().toLocal8Bit().constData();
 ...
 ******************************************************************************/
void ShowBox::sliderRangeChanged(int min, int max)
{
 ...
 ******************************************************************************/
void ShowBox::executeCommand(DialogCommand command)
{
