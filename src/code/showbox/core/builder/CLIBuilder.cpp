...
QWidget* CLIBuilder::buildSpinBox(const Showbox::Models::SpinBoxConfig& config) {
...
QWidget* CLIBuilder::buildTextEdit(const Showbox::Models::TextEditConfig& config) {
...
QWidget* CLIBuilder::buildGroupBox(const Showbox::Models::GroupBoxConfig& config) {
...
QWidget* CLIBuilder::buildTabWidget(const Showbox::Models::TabWidgetConfig& config) {
